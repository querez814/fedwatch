...
export const GET: RequestHandler = async () => {
    ...
    const url = `https://api.stlouisfed.org/fred/series/observations?series_id=WSHOSHO&api_key=${VITE_FRED_API}&file_type=json&observation_start=2020-01-01&observation_end=${today}`;
